<?php 
	...
	require_once('../model/ajout-cotation.php');
	$ent=$_SESSION['entreprise'];
 ?>
					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box bg-white box-shadow border-radius-10">
							<div class="login-title">
								<h2 class="text-center text-primary">Ajouter Cotation</h2>	
							</div>
							...
							<?php
								$ps=$pdo->prepare("SELECT * FROM affectation WHERE code_entreprise='$ent'");
								$ps->execute();
								?>
								...
								?>
								<option value="<?php echo $s->code_etudiant; ?>">
									<?php echo $s->code_etudiant; ?>
								</option>
									<?php
									}
								?>
								...
								<div class="form-group">
									...
									<input
										type="file"
										class="form-control"
										placeholder="fichier" name="fichier"
									/>
								</div>								
								<div class="row">
									<div class="col-sm-12">
